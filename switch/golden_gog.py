...
class AnyDevice(gatt.Device):
    ...
    def services_resolved(self):
        ...
        #_LOGGER.error("[%s] Resolved services" % (self.mac_address))
        #for service in self.services:
            #_LOGGER.error("[%s]  Service [%s]" % (self.mac_address, service.uuid))
            #for characteristic in service.characteristics:
                #_LOGGER.error("[%s]    Characteristic [%s]" % (self.mac_address, characteristic.uuid))
...
class ArduinoSwitch(SwitchDevice):
    ...
    def turn_on(self):
        ...
        #os.system("sudo python3 /home/pi/riccardo/sync/script.py")

        #subprocess.call("sudo python3 /home/pi/riccardo/sync/script.py", shell=True)
